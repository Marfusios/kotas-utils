using System;
using System.Linq;
using Kotas.Utils.Common.Attributes;
...
namespace Kotas.Utils.Common.Utils
{
    public static class EnumUtils
    {
        ...
        {
            return e.GetAttribute<StringValueAttribute>().Value;
        }
        ...
        public static T GetFieldByStringValue<T>(this T t, string expected)
        {
            ...
            {
                var stringValueAttribute = (StringValueAttribute)fieldInfo.GetCustomAttributes(typeof(StringValueAttribute), true).FirstOrDefault();
